package com.anyu.tiangou.goods.service.impl;

import com.anyu.tiangou.goods.mapper.CategoryMapper;
import com.anyu.tiangou.goods.model.Category;
import com.anyu.tiangou.goods.model.CategoryOptions;
import com.anyu.tiangou.goods.service.api.ICategoryService;
...
public class CategoryServiceImpl implements ICategoryService {
    ...
    public void update(Category category){
        ...
        int i1 = categoryMapper.updateByPrimaryKeySelective(category);
...
//        System.out.println(i);
    ...
    @Override
    public List<CategoryOptions> findByPid(String pid) {
        
        List<CategoryOptions> categoryOptions = categoryMapper.optionList("0");
        for (CategoryOptions categoryOption : categoryOptions) {
            List<CategoryOptions> categoryOptions1 = categoryMapper.optionList(categoryOption.getValue().toString());
            categoryOption.setChildren(categoryOptions1);
            for (CategoryOptions options : categoryOptions1) {
                List<CategoryOptions> categoryOptions2 = categoryMapper.optionList(options.getValue().toString());
                options.setChildren(categoryOptions2);
