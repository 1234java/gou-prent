...
public class User implements Serializable{
	...
	public User(String username, String password, String phone, String email, Date created, Date updated, String sourceType, String nickName, String name, String status, String headPic, String qq, String isMobileCheck, String isEmailCheck, String sex, Integer userLevel, Integer points, Integer experienceValue, Date birthday, Date lastLoginTime) {
