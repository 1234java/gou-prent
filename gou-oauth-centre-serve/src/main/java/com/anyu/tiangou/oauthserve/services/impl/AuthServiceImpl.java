package com.anyu.tiangou.oauthserve.services.impl;
...
public class AuthServiceImpl implements AuthService {
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret) {
        ...
        //选中认证服务的地址
        ServiceInstance serviceInstance = loadBalancerClient.choose("oauth-serve");
        ...
        String info = (String)map.get("userinfo");
        System.out.println(info);
        //jti，作为用户的身份标识
        String jwtToken= (String) map.get("jti");
        authToken.setJti(jwtToken);
        authToken.setInfo(info);
